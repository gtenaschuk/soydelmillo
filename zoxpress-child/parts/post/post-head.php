			...
			<?php } else { ?>
				<div class="zox-post-byline-wrap">
                    <div class="zox-author-thumb">
                        ...
                        if (has_custom_logo()) {
                            echo '<img style="object-fit: contain; width: 100%; src="'. esc_url($logo[0]) .'" alt="'. get_bloginfo('name') .'">';
                        } else {
                            echo '<img src="https://soydelmillo.com/wp-content/uploads/2021/11/soydelmillothin.png" alt="'. get_bloginfo('name') .'" style="object-fit: contain; width: 100%;">';
                        }
                        ?>
                    </div><!--zox-author-thumb-->
					<div class="zox-author-info-wrap">
						<div class="zox-author-name-wrap" itemprop="author" itemscope itemtype="https://schema.org/Person">
							<p><?php esc_html_e( 'By', 'zoxpress' ); ?></p><span class="zox-author-name vcard fn author" itemprop="name">Redacción soy del millo</span>
